<?php
    ...
    class MagicToolboxCoreInstallerClass {
        ...
        function sendStat($mode = '') {
            ...
            if('working' == 'v4.4.19' || 'working' == 'v5.2.6') {
                return;
            }
            ...
            $path = "api/stat/?action={$mode}&tool_name=magiczoomplus&license=trial&tool_version=v5.2.6&module_version=v4.4.19&platform_name=opencart&platform_version={$platformVersion}&url={$url}";
